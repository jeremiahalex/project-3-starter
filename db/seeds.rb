...
Deal.create(name: "Omg free ice-cream!", description: "You all better go for all the group outtings. Maybe Prima will buy us ice-cream as a class!", pax: 16, restaurant_id: 11, img: "http://i.imgur.com/AgfzAQm.jpg")
